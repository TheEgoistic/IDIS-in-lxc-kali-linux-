# IDIS-in-lxc-kali-linux-
This projecte is demo to is IDIS in lxc kali linux as it is light wieght via suricata
####Note Steps ####
1)create lxc kali linux system 
2)create python enivronment
3)setup suricata on kali linux (lxc)
4)add rules in suricata in /var/lib/suricata/rule
